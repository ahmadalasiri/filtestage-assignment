  ...
  const handleSelectUser = useCallback((user) => {
    ...
    try {
      ...
      const newValue = 
        ...
        '@' + username + ' ' + 
        value.substring(mentionState.mentionStartIndex + mentionState.mentionQuery.length + 1);
      ...
      const newCursorPosition = mentionState.mentionStartIndex + username.length + 2; // +2 for @ and space
